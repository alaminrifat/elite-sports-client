                        ...
                        <div className=" rounded-lg bg-slate-100 shadow-lg dark:bg-slate-600 dark:shadow-black/30 mb-10">
                            ...
                            <div className="p-6">
                                ...
                                <p className="mt-4">
                                    ...
                                    The coaches at Elite Sports Academy are
                                    exceptional. They push you to reach your
                                    full potential.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className=" rounded-lg bg-slate-100 shadow-lg dark:bg-slate-600 dark:shadow-black/30 mb-10">
                            ...
                            <div className="p-6">
                                ...
                                <p className="mt-4">
                                    ...
                                    Joining Elite Sports Academy was the best
                                    decision I made. It's a game-changer for
                                    aspiring athletes!
                                </p>
                            </div>
                        </div>
